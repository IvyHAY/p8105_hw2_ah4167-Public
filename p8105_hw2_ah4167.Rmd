...
I firstly import the data and omit non-data entries. Then I remove any participants who have no MCI at baseline. Finally I transfer the wide format data to long format data. 
There are There are `r nrow(read.csv("./data/data_mci/mci_amyloid.csv",skip=1))` participants recruited, `r nrow(read.csv("./data/data_mci/mci_amyloid.csv",skip=1)|>janitor::clean_names()|>subset( baseline!="NA"))` of them have the biomarker at the baseline. The proportion of those participants who complete the whole process is  `r nrow(read.csv("./data/data_mci/mci_amyloid.csv",skip=1)|>janitor::clean_names()|>subset(baseline!="NA"&time_2 !="NA"&time_4!="NA"&time_6!="NA"&time_8!="NA"))/nrow(read.csv("./data/data_mci/mci_amyloid.csv",skip=1)|>janitor::clean_names()|>subset( baseline!="NA"))`.
